...
\begin{lemma}\label{lem:xequals} Let $(f,x,y)$ be an optimal solution to an SMT instance. Then for each arc $(i,j)\in A$, exactly one of the following two properties holds:
\begin{enumerate}[a)]
...
\begin{figure}[h!]
        \centering
        \includegraphics[height=2.0in]{counterex}
